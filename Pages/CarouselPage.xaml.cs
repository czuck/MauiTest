...
public partial class CarouselPage : ContentPage
{
    ...
    private void Carousel_OnPositionChanged(object sender, PositionChangedEventArgs e)
    {
        var Monkey = CurrentMonkey;
    }
